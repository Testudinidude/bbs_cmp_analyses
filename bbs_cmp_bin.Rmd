...
write_rds(out.ms.fulllandveg,"out.ms.fulllandveg.rds")
...
out.ms.fulllandveg<-read_rds("out.ms.fulllandveg.rds")
...
tolrelpred<-predict(out.ms.fulllandveg,as.matrix(occu_tolrel_newdata))

ldipred<-predict(out.ms.fulllandveg,as.matrix(occu_ldi_newdata))
...
occu_ldi_newdata<-read_rds("occu_ldi_newdata.rds")
occu_tolrel_newdata<-read_rds("occu_tolrel_newdata.rds")
