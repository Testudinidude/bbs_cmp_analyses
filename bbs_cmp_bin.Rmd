...
fit_pcoa_spp_order$color_resid[fit_pcoa_spp_order$Residency %in% "M"]<-"green"
...
pcoa_plot_new <- ggplot(plot_df_pcoa, aes(x = MDS1, y = MDS2)) +
  ...
  geom_segment(data = fit_pcoa_spp_order, aes(x = 0, xend = MDS1, y = 0, yend = MDS2), col = col_pcoa) +
  geom_text(data = fit_pcoa_spp_order, aes(label = SpeciesCode),colour=col_pcoa) 
pcoa_plot_new


ggplot(plot_df_pcoa, aes(x = MDS1, y = MDS2)) +
    coord_fixed(xlim = c(-0.8,0.8),ylim=c(-0.6,0.4)) +geom_segment(data = fit_pcoa_spp_order[fit_pcoa_spp_order$Residency == "NE",], aes(x = 0, xend = MDS1, y = 0, yend = MDS2), col = col_pcoa[fit_pcoa_spp_order$Residency == "NE"]) +
    geom_text(data = fit_pcoa_spp_order[fit_pcoa_spp_order$Residency == "NE",], aes(label = SpeciesCode),colour=col_pcoa[fit_pcoa_spp_order$Residency == "NE"])+theme_classic(base_size=16)
...
ggplot(aes(x=RDA1,y=species),data=fitconcrda_spp_order)+geom_point()+theme_classic(base_size=12)+theme(axis.text.y = element_text(colour = color_sub))
...
community<-factor(CMP_bbs_pcap_join_pcaponly_pcapsum$community)
...
ggord(lda_birdcomm, community, xlim=c(-15,30),ylim = c(-15, 15),alpha=0,alpha_el=0.5)
...
bbs_occobject$occ.covs<-as.matrix(vegecomm[,-(1:3)])

bbs_occobject$coords<-as.matrix(vegecomm[,2:3])
...
#  crs(r)<-"+proj=longlat +datum=NAD83"
  ...
  idwrasters[[i]]<-r3
  writeRaster(maxint,filename = paste0("U:/DataAnalysis/BreedingBirds",sppnames[i],"_occmeanpsi_globalmod_idw_origbbslocs_rev.asc"),overwrite=TRUE)
  
}

saveRDS(idwrasters,"U:/DataAnalysis/BreedingBirds/idwrasters_global.Rdata")
...
ggplot(aes(x=Mean,y=spp_tolorder),data=covars_tolerance)+geom_point()+geom_errorbarh(aes(xmin=X5.0CI,xmax=X95.0CI))+geom_vline(xintercept=0.1652)+theme_classic(base_size=12)
...
ggplot(aes(x=Mean,y=spp_svporder),data=covars_svp)+geom_point()+geom_errorbarh(aes(xmin=X5.0CI,xmax=X95.0CI))+geom_vline(xintercept=-0.0594)+theme_classic(base_size=12)
...
ggplot(aes(x=Mean,y=spp_dicotorder),data=covars_dicot)+geom_point()+geom_errorbarh(aes(xmin=X5.0CI,xmax=X95.0CI))+geom_vline(xintercept=0.2461)+theme_classic(base_size=12)
...
ggplot(aes(x=Mean,y=spp_cyperorder),data=covars_cyper)+geom_point()+geom_errorbarh(aes(xmin=X5.0CI,xmax=X95.0CI))+geom_vline(xintercept=-0.1375)+theme_classic(base_size=12)
...
ggplot(aes(x=Mean,y=spp_treeorder),data=covars_smalltree)+geom_point()+geom_errorbarh(aes(xmin=X5.0CI,xmax=X95.0CI))+geom_vline(xintercept=0.0672)+theme_classic(base_size=12)
...
ggplot(aes(x=Mean,y=spp_shruborder),data=covars_shrub)+geom_point()+geom_errorbarh(aes(xmin=X5.0CI,xmax=X95.0CI))+geom_vline(xintercept=-0.2181)+theme_classic(base_size=12)
...
ggplot(aes(x=Mean,y=spp_hydroorder),data=covars_hydro)+geom_point()+geom_errorbarh(aes(xmin=X5.0CI,xmax=X95.0CI))+geom_vline(xintercept=0.2068)+theme_classic(base_size=12)
...
ggplot(aes(x=Mean,y=spp_subcanopyorder),data=covars_subcanopy)+geom_point()+geom_errorbarh(aes(xmin=X5.0CI,xmax=X95.0CI))+geom_vline(xintercept=-0.0393)+theme_classic(base_size=12)
...
ggplot(aes(x=Mean,y=spp_canopyorder),data=covars_canopy)+geom_point()+geom_errorbarh(aes(xmin=X5.0CI,xmax=X95.0CI))+geom_vline(xintercept=-0.0702)+theme_classic(base_size=12)
```
